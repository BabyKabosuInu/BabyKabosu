          ...
          <div className="flex flex-row ">
            ...
            <div>
              ...
              <p className="">
                ...
                <br />
                <small className="font-normal"> - Whitepaper & Website</small>
                <br />
                <small className="font-normal"> - Baby Kabosu Inu</small>
                <br />
                <br />
                ...
                <br />
                <small className="font-normal">
                  - Influencer promotional material  (Youtube, TikTok, Twitter and more)
                </small>
                <br />
                <br />
                <strong className="">Listings:</strong>
                <br />
                <small className="font-normal">- Baby Kabosu on CoinMarketCap</small>
                <br />
                <small className="font-normal">- Baby Kabosu on CoinGecko</small>
                <br />
                <small className="font-normal">
                  - Baby Kabosu on centralized Exchange
                </small>
                <br />
                <br />
            ...
            <div>
              ...
              <p className="">
                ...
                <br />
                <small className="font-normal">
                  - Additional centralized Exchanges for Baby Kabosu
                </small>
                <br />
                <br />
                <strong className="">Marketing:</strong>
